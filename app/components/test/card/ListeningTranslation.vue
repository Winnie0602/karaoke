...
const { eachLyric, isNowCard, life, translationGameLang, allLyrics } =
  defineProps<{
...
<template>
  <div
    class="relative flex w-full items-center justify-center border-[3px] transition-all duration-500 md:border-[5px] md:px-8 md:py-10"
    :class="[
      isNowCard
  ...
  >
    ...
    <div class="flex w-full flex-col space-y-3">
      <button
        ...
        :class="{
          'hover:border-[#F9595F] hover:bg-white hover:shadow-md': !hasAnswered,
      ...
      >
        ...
        <div
          class="ml-4 text-sm text-[#7A3A3A]"
